...
/**
 * 34 Temi di Talento distribuiti sulle 4 macro-aree del modello Gallup
...
export const THEMES: ThemeSeed[] = [
  ...
  },
  {
    ...
    fullDescription:
      "Il Coordinatore è un direttore d'orchestra della complessità. Di fronte a molte variabili in movimento — persone, scadenze, risorse — non si sente sopraffatto: si sente nel proprio elemento. La domanda ricorrente è «come possiamo disporre i pezzi perché rendano di più?».\n\nA differenza di chi cerca la struttura per ridurre l'incertezza, il Coordinatore ama proprio riconfigurare: prova una disposizione, la osserva, la cambia. È flessibile per natura, e questa flessibilità è ciò che gli permette di ottimizzare mentre gli altri stanno ancora pianificando.\n\nIl tema matura quando la riconfigurazione smette di essere continua: a un certo punto una disposizione va lasciata stabilizzare, perché anche le persone hanno bisogno di sapere dove stanno.",
    strengths: [
  ...
  },
  {
    ...
    fullDescription:
      "Il tema Equità nasce dalla convinzione che le persone vadano trattate allo stesso modo, con regole chiare e valide per tutti. Le eccezioni concesse in base alla simpatia o al potere sono, per questa persona, una ferita al patto sociale del gruppo.\n\nÈ un talento che protegge le organizzazioni: dove c'è Equità, i processi sono trasparenti, i criteri dichiarati, le decisioni difendibili. Le persone sanno cosa aspettarsi e questo riduce enormemente il rumore politico.\n\nLa versione matura del tema riconosce che trattamento uguale e trattamento equo non sempre coincidono: persone in situazioni diverse possono aver bisogno di supporti diversi per avere davvero le stesse opportunità.",
    strengths: [
