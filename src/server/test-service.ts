  ...
  const result = await prisma.$transaction(async (tx) => {
    const created = await tx.testResult.create({
      data: {
        ...
        executingScore: outcome.domainScores.OPERATIONAL,
        influencingScore: outcome.domainScores.INTERPERSONAL,
        relationshipScore: outcome.domainScores.SUPPORTIVE,
        strategicScore: outcome.domainScores.COGNITIVE,
